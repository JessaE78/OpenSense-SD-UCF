...
#include "SparkFun_VL53L1X.h"     // VL53L4CD Time of Flight Sensor. Had a lot of libraries inserted must check this sensor works
...
float Poll_SGP30_Sensor(String choice){
  if (! sgp30.IAQmeasure()) {
...
// }
float Poll_BME280_Sensor(String choice){
...
uint16_t Poll_TSL2591_Sensor(String choice){
...
float Poll_MPL3115A2_Sensor(String choice){
  if(choice == "Pressure"){
